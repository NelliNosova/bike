...
/* harmony import */ var _modules_menu_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu-nav */ "./js/modules/menu-nav.js");
...
Object(_modules_menu_nav__WEBPACK_IMPORTED_MODULE_3__["toggleMenu"])();
Object(_modules_form__WEBPACK_IMPORTED_MODULE_4__["checkForm"])();
...
var ERROR_PHONE_MESSAGE = 'Введите телефон в фромате 1-123-123-1234';
var PHONE_NUMBER = /^[\+]?[0-9]{1}[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4}$/im;
...
var menuBtn = mainNav.querySelector('.js-menu-toggle');
var menuItems = mainNav.querySelectorAll('.js__menu-item');
  ...
  try {
    var _loop = function _loop() {
      ...
      anchor.addEventListener('click', function (evt) {
        evt.preventDefault();
        var linkID = anchor.getAttribute('href').substr(1);
        var blockID = document.getElementById(linkID);
